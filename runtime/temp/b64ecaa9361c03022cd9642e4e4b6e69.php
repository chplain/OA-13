			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="<?php echo url('blogtype/index'); ?>">博客分类</a>
						</li>
				...
				<div class="page-content">			
					<div style="width:726px;margin:0px;text-align:center;">
						<h3 style="margin-left:60px;">分类修改</h3>
						<form method="POST" action="<?php echo url('blogtype/edit'); ?>" class='form-horizontal'>
						<input type="hidden" name="id" value="<?php echo $info['id']; ?>">						
						 	<div class="form-group">
								<label class="col-sm-2 control-label" for="a">分类名称:</label>
								<div class="col-sm-10">
								<input type="text" name="type" value="<?php echo $info['type']; ?>" class='form-control' id="a">	
								</div>
						 	</div>
