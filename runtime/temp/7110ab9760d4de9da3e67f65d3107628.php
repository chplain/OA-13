			...
			<div class="main-content-inner">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="<?php echo url('blog/index'); ?>">我的博客</a>
						</li>
				...
				<div class="page-content">			
					<div style="width:726px;margin:0px;text-align:center;">
						<h3 style="margin-left:60px;">修改博客</h3>
						<form method="POST" action="<?php echo url('blog/edit'); ?>" class='form-horizontal'>
						<input type="hidden" name="id" value="<?php echo $info['id']; ?>">						
						 	<div class="form-group">
								<label class="col-sm-2 control-label" for="a">标题:</label>
								<div class="col-sm-10">
								<input type="text" name="title" value="<?php echo $info['title']; ?>" class='form-control' id="a">	
								</div>
						 	</div>
						 	<div class="form-group">
								...
								<select name="type" class="form-control">
									...
									<option value="<?php echo $type['id']; ?>"  <?php if($info['type_id'] == $type['id']): ?>selected<?php endif; ?>><?php echo $type['type']; ?></option>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</select>	
								</div>
						 	</div>
						 	<div class="form-group">
								<label class="col-sm-2 control-label" for="a">状态:</label>
								<div class="col-sm-10">
								<select name="status" class="form-control">
									<option value="">请选择状态</option>				
									<option value="0" <?php if($info['status'] == 0): ?>selected<?php endif; ?>>新提交</option>									
									<option value="1" <?php if($info['status'] == 1): ?>selected<?php endif; ?>>已审批</option>									
									<option value="2" <?php if($info['status'] == 2): ?>selected<?php endif; ?>>驳回</option>									
								</select>	
								</div>
						 	</div>	
							...
							<div class="col-sm-10">
								<script id="editor" type="text/plain" style="width:600px;height:400px;"><?php echo $info['content']; ?></script>	
							</div>
							</div>	
