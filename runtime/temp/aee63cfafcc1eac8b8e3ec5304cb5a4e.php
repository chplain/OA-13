		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					<div class="row">
						<div class="cf">
							<a class="btn btn-info" href="<?php echo url('weektype/add'); ?>">新增</a>
							...
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td  class="center">
											<a href="<?php echo url('weektype/edit',array('id'=>$value['id'])); ?>">修改</a>&nbsp;|
...
<script type="text/javascript">
	$(".del").click(function(){
		...
		layer.confirm("确定要删除该用户吗?",function(index){
			// alert(index);
			$.get('<?php echo url("weektype/del"); ?>',{id:id},function(res){
				// alert(1);
				if (res.code == 1) {
					layer.close(index);	
	...
	// function btn_cache(){
	// 	// alert(1);
	// 	$.post("<?php echo url('weektype/index'); ?>",{type:'cache'},function(res){
	// 		alert(res);
	// 	});
	// }
