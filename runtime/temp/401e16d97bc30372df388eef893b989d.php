			...
			<div class="main-content-inner">
				...
				<div class="page-content">			
					<div style="width:726px;margin:0px;text-align:center;">
						...
						<form method="POST" action="<?php echo url('blogtype/add'); ?>" class='form-horizontal'>						
