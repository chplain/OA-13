				...
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<div class="row">
								<div class="cf">
									<a class="btn btn-info" href="<?php echo url('group/add'); ?>">新增</a>
								</div>
									...
									<table class="table table-striped table-bordered table-hover">
										...
										<tbody>			
											...
											<tr>
												...
												<td class="center">
													<?php if($val['id'] != 1): ?>
													<a href="<?php echo url('group/edit',array('id'=>$val['id'])); ?>">修改</a>&nbsp;
													<a class="del" href="javascript:;" title="删除" data-id="<?php echo $val['id']; ?>">删除</a>
													<?php else: ?>
													<a href="<?php echo url('group/edit',array('id'=>$val['id'])); ?>">查看</a>
													<?php endif; ?>
												</td>
											</tr>
											<?php endforeach; endif; else: echo "" ;endif; ?>							                               
...
<script type="text/javascript">
	$(".del").click(function(){
		...
		layer.confirm("确定要删除该用户组吗?",function(index){
			$.get('<?php echo url("group/del"); ?>',{groupid:gid},function(res){
				if (res.code == 1) {
					layer.close(index);
