		...
		<div class="page-content">
			<div class="row">
				<div class="col-xs-12">
					<div class="row">
						<div class="cf">
							<a class="btn btn-info" href="<?php echo url('blog/add'); ?>">新增</a>
							...
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<tr>
										...
										<td  class="center">
											<a href="<?php echo url('blog/edit',array('id'=>$value['id'])); ?>" <?php if($value['status'] == 1): ?>style="pointer-events: none; color:#999;"<?php endif; ?> >修改</a>&nbsp;|
...
<script type="text/javascript">
	$(".del").click(function(){
		...
		layer.confirm("确定要删除该用户吗?",function(index){
			// alert(index);
			$.get('<?php echo url("blog/del"); ?>',{wid:id},function(res){
	...
	function btn_cache(){
		// alert(1);
		$.post("<?php echo url('blog/index'); ?>",{type:'cache'},function(res){
			alert(res);
		});
	}
